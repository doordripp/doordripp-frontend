          ...
          <div className="relative w-full max-w-[320px] md:max-w-[360px] lg:max-w-[400px] group">
            ...
            <div className="relative rounded-3xl overflow-hidden shadow-2xl transition-all duration-500 hover:shadow-3xl hover:-translate-y-2 ring-4 ring-black">
              ...
              <div className="relative overflow-hidden">
                {/* Images container */}
                <div className="relative w-full h-[360px] md:h-[400px] lg:h-[440px]">
                  ...
                  {/* Gradient overlay */}
                  <div className="absolute inset-0 bg-gradient-to-t from-black/10 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 z-20"></div>
                </div>
