  ...
  useEffect(() => {
    ...
    apiGet('/products?page=1&limit=100')
      ...
      .catch(err => {
        ...
        if (mounted) {
          setError('Failed to load footwear products. Please try again later.')
          setProducts([])
        }
      })
      ...
      <div className="mx-auto max-w-[1400px] px-4 sm:px-6 lg:px-8">
        ...
        {loading ? (
          <div className="text-center py-12">
            <p className="text-gray-600">Loading footwear...</p>
          </div>
        ) : error ? (
          <div className="text-center py-12">
          ...
          <div className="text-center py-12">
            <p className="text-gray-500">No footwear products available at the moment.</p>
          </div>
        ) : (
