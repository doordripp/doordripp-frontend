...
export default function FootwearSection() {
  // Use footwear products and fill with men's products to show 6 products
  const displayProducts = [...FOOTWEAR_PRODUCTS, ...MENS_PRODUCTS].slice(0, 6)

  return (
    <section id="footwear" className="w-full bg-gray-100 py-16 lg:py-20">
